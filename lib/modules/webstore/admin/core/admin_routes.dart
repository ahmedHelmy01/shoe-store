...
class AdminRoutes {
  static const all = <AdminNavNode>[
    ...
    AdminNavNode(
      ...
      children: [
        ...
        AdminNavNode(
          id: AdminRouteId.offers,
          routeName: AppRouteNames.webstoreAdminOffers,
          title: 'Offers',
  ...
  static AdminRouteId fromRouteName(String? name) {
    return switch (name) {
      ...
      AppRouteNames.webstoreAdminPrescriptions => AdminRouteId.prescriptions,
      ...
      AppRouteNames.webstoreAdminOffers => AdminRouteId.offers,
  ...
  static String toRouteName(AdminRouteId id) {
    return switch (id) {
      ...
      AdminRouteId.prescriptions => AppRouteNames.webstoreAdminPrescriptions,
      ...
      AdminRouteId.offers => AppRouteNames.webstoreAdminOffers,
