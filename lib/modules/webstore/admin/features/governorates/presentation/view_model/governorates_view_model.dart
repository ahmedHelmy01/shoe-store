...
class GovernoratesVm extends AdminCrudVm<GovernorateRow> {
  ...
  @override
  Future<ApiResult<GovernorateRow>> saveItem(Map<String, dynamic> data, {dynamic id, XFile? imageFile, Map<String, dynamic>? extraData, void Function(double)? onProgress}) {
