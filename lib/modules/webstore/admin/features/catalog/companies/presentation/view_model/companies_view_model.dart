...
class CompaniesVm extends AdminCrudVm<CompanyRow> {
  ...
  @override
  Future<ApiResult<CompanyRow>> saveItem(Map<String, dynamic> data, {dynamic id, XFile? imageFile, Map<String, dynamic>? extraData, void Function(double)? onProgress}) {
    return ref.read(companiesRepositoryProvider).saveCompany(data, id: id as int?, logoFile: imageFile);
  }
