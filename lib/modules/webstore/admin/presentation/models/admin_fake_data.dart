...
class AdminFakeData {
  ...
  static List<AdminOrderRow> orders({int count = 63, int seed = 23}) {
    final rnd = Random(seed);
  ...
  static List<AdminCompanyRow> companies({int count = 26, int seed = 53}) {
    final rnd = Random(seed);
    const names = [
      'Astra Pharma',
      'Nile Med',
  ...
  static List<AdminFilterRow> filters({int count = 18, int seed = 59}) {
    final rnd = Random(seed);
    const names = [
      'Brand',
      'Price Range',
