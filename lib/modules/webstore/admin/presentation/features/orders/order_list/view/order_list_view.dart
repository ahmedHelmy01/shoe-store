...
import 'package:erp/modules/webstore/admin/presentation/features/orders/order_list/widgets/order_status_dropdown.dart';

class OrderListView extends StatelessWidget {
  final TabController tabController;
  final List<String> statuses;
  final List<AdminOrderRow> allOrders;
  final List<AdminOrderRow> visibleRows;
  final DateFormat dateFormat;
  final void Function(AdminOrderRow row, String status) onStatusChanged;
  ...
  Widget build(BuildContext context) {
    ...
    final table = isWide
        ? AdminDataTable<AdminOrderRow>(
            rows: items,
            idOf: (o) => '${o.id}',
            exportBaseName: 'orders',
            searchHint: 'Search orders…',
            searchText: (o) =>
                '${o.id} ${o.customer} ${o.status} ${o.payment} ${o.total}',
            columns: [
              AdminColumn<AdminOrderRow>(
                title: 'Order #',
                sortable: true,
                sortValue: (o) => o.id,
                exportValue: (o) => '${o.id}',
        ...
        : ListView.separated(
            ...
            itemBuilder: (context, i) {
              ...
              return ListTile(
                ...
                subtitle: Text(
                  '${o.payment} • ${o.total.toStringAsFixed(2)} • ${df.format(o.createdAt)}',
                ),
                trailing: SizedBox(
                  width: 140,
          ...
          Material(
            ...
            child: TabBar(
              ...
              tabs: [
                ...
                ...statuses.map(
                  (s) => Tab(
                    text: '$s (${allOrders.where((o) => o.status == s).length})',
                  ),
                ),
              ],
            ),
