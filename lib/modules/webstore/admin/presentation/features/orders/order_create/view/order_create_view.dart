...
import 'package:erp/modules/webstore/admin/presentation/features/orders/order_create/widgets/order_qty_chip.dart';
import 'package:erp/modules/webstore/admin/presentation/features/orders/order_create/widgets/order_summary_row.dart';

const _kDiscountOptions = [0, 5, 10, 15, 20];
const _kPayments = ['Cash', 'Card', 'InstaPay'];

class OrderCreateView extends StatelessWidget {
  final OrderCreateBinding b;
            ...
            child: Column(
              ...
              children: [
                ...
                AppDropdown<String>(
                  ...
                  value: b.addressLine != null &&
                          b.addressChoices.contains(b.addressLine)
                      ? b.addressLine
                      : null,
                  borderRadius: 12,
                  contentPadding: const EdgeInsets.symmetric(
            ...
            child: Column(
              ...
              children: [
                ...
                OrderSummaryRow(
                  ...
                  value: b.subtotal.toStringAsFixed(2),
                  theme: theme,
                ),
                ...
                OrderSummaryRow(
                  label: 'الإجمالي',
                  value: b.total.toStringAsFixed(2),
                  theme: theme,
                  emphasize: true,
                ),
                const SizedBox(height: 12),
